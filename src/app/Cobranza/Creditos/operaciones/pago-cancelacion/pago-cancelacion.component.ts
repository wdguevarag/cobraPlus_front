...
@Component({
  selector: 'app-pago-cancelacion',
  templateUrl: './pago-cancelacion.component.html',
  styleUrl: './pago-cancelacion.component.scss'
})
export class PagoCancelacionComponent implements OnInit {
  ...
  onRowClick(event: { id: number }): void {
    ...
    this.router.navigate([`creditos/operacion/pago-cancelacion/single-pago-cancelacion`, event.id]);
  }
}
