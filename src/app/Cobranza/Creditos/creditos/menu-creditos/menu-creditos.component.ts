...
@Component({
  selector: 'app-menu-creditos',
  templateUrl: './menu-creditos.component.html',
  styleUrl: './menu-creditos.component.scss'
})
export class MenuCreditosComponent implements OnInit {
